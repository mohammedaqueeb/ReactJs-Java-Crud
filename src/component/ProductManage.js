          ...
          <Grid container spacing={2} mb={1.5}>
            ...
            <Grid item xs={6}>
              <TextField
                ...
                required
              >
                <MenuItem value="Level 1" selected>
                  Level 1
                </MenuItem>
                <MenuItem value="Level 2" selected>
                  Level 2
                </MenuItem>
                <MenuItem value="Level 3" selected>
                  Level 3
                </MenuItem>
                <MenuItem value="Level 4" selected>
                  Level 4
                </MenuItem>
                <MenuItem value="Level 5" selected>
                  Level 5
                </MenuItem>
                <MenuItem value="Level 6" selected>
                  Level 6
                </MenuItem>
              </TextField>
            </Grid>
