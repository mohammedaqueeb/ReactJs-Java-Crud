...
export default function ProductList() {
  ...
  return (
    ...
    <h3 className="mb-3">Product List <Button variant="contained" component={Link} to="/product-manage" className="float-right">ADD PRODUCT</Button> </h3>
                ...
                products.map((product, index) => (
                    <TableRow key={product.id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>   
                        ...
                        <TableCell align="left">
                            <IconButton component={Link} to={`/product-manage/${product.id}`} ><EditIcon /></IconButton>
                            <IconButton onClick={() => deleteUser(product.id)}><DeleteIcon /></IconButton>
